...
<body>
    ...
    <div class="card card-body bg-light mt-5">
        ...
        <form action="proceso_agregar_pokemon.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="tipo" class="form-control form-control-lg" required autofocus>
            </div>
            <div class="form-group">
                <label for="imagen">Imagen: </label>
                <input type="file" name="imagen" class="form-control form-control-lg" required autofocus>
            </div>
